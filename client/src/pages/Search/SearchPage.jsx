...
const searchBannerStyle = css`
    ...
    .custom-shape-divider-bottom-1634653356 {
        position: absolute;
        bottom: 0;
        left: 0;
        width: 100%;
    ...
    .custom-shape-divider-bottom-1634653356 svg {
        position: relative;
        display: block;
    ...
    .custom-shape-divider-bottom-1634653356 .shape-fill {
        fill: #f62da8;
    }
`;
    ...
    return (
        <div>
            <div css={searchBannerStyle}>
                ...
                <div class="custom-shape-divider-bottom-1634653356">
                    <svg
                        data-name="Layer 1"
